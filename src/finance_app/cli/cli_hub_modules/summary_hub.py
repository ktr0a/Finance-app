...
from finance_app.cli.ui.text import (
...
import finance_app.cli.ui.params as ui_params
...
def display_summary(result, sumtemp, engine):
    ...
    if result.keys() == sumtemp.keys():
        ...
        spacerh1 = ui_params.spacer1
        spacerh3 = ui_params.spacer2

        divider1 = ui_params.vertical_divider
        divider2 = ui_params.horizontal_divider
        ...
        for section in (pr.INCOME, pr.EXPENSE):
            ...
            print(f"{' ' * ui_params.spacer3}{count_label}: {engine.format_value(count_value, 'int').data}")
            print(f"{' ' * ui_params.spacer3}{total_label}: {engine.format_value(total_value, 'money').data}")
            print()

...
from finance_app.cli.cli_hub_modules.main_hub import hub
from finance_app.core import core_config

from finance_app.cli.cli_hub_modules.calc_hub import calc_loop
import scripts.run_cli as main
import finance_app.infra.storage_legacy as storage
import time
...
def main():
    import finance_app.infra.pdf.general_extract_rawdata as pdf_rawdata
    import finance_app.infra.pdf.erste_bank.erste_format_rawdata as pdf_format
    import finance_app.infra.pdf.parameter as pdf_parameter
...
def asdfsd():
    from finance_app.infra.pdf.pdf_test import example_item as e_item
...
if __name__ == "__main__":
    import finance_app.infra.pdf.erste_bank.erste_manual_data_mapper as mdm
    import finance_app.infra.pdf.general_extract_rawdata as rd
    import finance_app.infra.pdf.erste_bank.erste_format_rawdata as f
    import finance_app.infra.pdf.parameter as p
